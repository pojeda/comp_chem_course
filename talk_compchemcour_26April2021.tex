...
\institute[Ume\aa~ University]{High Performance Computing Center (HPC2N), \\
Ume\aa~ University,\\[1em]\includegraphics[width=0.8cm]{umea_logo.eps} \\
901 87, Sweden.}
...
\begin{figure}
\includegraphics[scale=0.14]{newton_apple.png}
...
\begin{figure}
\includegraphics[scale=0.15]{energy_landscape.png}
...
\begin{figure}
\includegraphics[scale=0.15]{cashier_lanes1.png}
...
\begin{figure}
\includegraphics[scale=0.15]{cashier_lanes2.png}
...
\begin{figure}
\includegraphics[scale=0.15]{cashier_lanes3.png}
